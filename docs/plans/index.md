...
| --- | --- | --- | --- |
| active | [Portable headless runtime roadmap](../architecture/portable-headless-roadmap.md) | `tools/winui3-mac-test-runtime` | Phase 12 macOS AX adapter is guarded with an optional/local AutomationCore-to-NSAccessibility scaffold and no portable-headless/default-PR-CI coupling. Next: start Phase 13 optional Windows custom-runtime UIA provider. |
