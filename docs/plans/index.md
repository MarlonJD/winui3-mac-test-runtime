...
| --- | --- | --- | --- |
| complete | [Portable headless runtime roadmap](../architecture/portable-headless-roadmap.md) | `tools/winui3-mac-test-runtime` | Phase 0-15 are guarded in repo. Phase 15 is closed by `release-hardening-manifest`, external developer docs, sample workflow guidance, and release-candidate manifest freshness. |
