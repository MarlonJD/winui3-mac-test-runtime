...
renderer. The public evidence set contains 58 component rows: 43 `usable` and
15 `not-rendered`. All public rows now have native/macOS/diff crop triptychs,
...
| `component-commands-menus-light` | failed | 28.441283% | 24% | 7.859141 | 35.183863 | 8 `usable`, zero `not-rendered` |
