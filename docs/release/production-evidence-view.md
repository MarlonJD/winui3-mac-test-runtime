...
| `component-basic-input-light` | Whole-image comparison fails with 97.801827% changed pixels over an 18% threshold. | Current public artifacts show 5 `usable` and 8 planned `not-rendered` rows; native control chrome remains approximate. |
